...
export TERRAFORM_PROVIDER_SOURCE := aaronfeng/aws
export TERRAFORM_PROVIDER_VERSION := 3.29.6
export TERRAFORM_PROVIDER_DOWNLOAD_NAME := terraform-provider-aws
export TERRAFORM_PROVIDER_DOWNLOAD_URL_PREFIX := https://github.com/aaronfeng/terraform-provider-aws/releases/download/v3.29.6
export TERRAFORM_NATIVE_PROVIDER_BINARY := terraform-provider-aws_v3.29.6
#https://github.com/aaronfeng/terraform-provider-aws/releases/download/v3.29.6/terraform-provider-aws_v3.29.6_linux_amd64.zip
