...
`provider-jet-aws` is a [Crossplane](https://crossplane.io/) provider that
...
```
kubectl crossplane install provider crossplane/provider-jet-aws:v0.1.0
```
...
open an [issue](https://github.com/crossplane-contrib/provider-jet-aws/issues).
